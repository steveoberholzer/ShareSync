...
/// <summary>
/// Represents a processing job for bulk SharePoint operations
/// </summary>
public class ProcessingJob
{
    ...
    /// <summary>
    /// Items belonging to this job
    /// </summary>
    public virtual ICollection<ProcessingJobItem> Items { get; set; } = new List<ProcessingJobItem>();
}
